...
public class Cells228 extends Cells28 {
    ...
    public void setValue2(Object t) {
        LOGGER.debug("{}.setValue2({}) called (class {})", dataFieldId2, t, t == null ? "N/A" : t.getClass().getSimpleName());
        deferredValue2 = t;
        if (idf2 != null) {
    ...
    public Object getValue2() {
        ...
        LOGGER.debug("{}.getValue2() called, returns {}", dataFieldId2, res);
        return res;
    }
    ...
    protected void myOnCreate() {
        ...
        if (dataField2 != null) {
            ...
            dataField2.addEventListener(Events.ON_CHANGE, (ev) -> {
                LOGGER.debug("onChange caught for {}, current value is {}", dataFieldId2, getValue());
                    Events.postEvent(new Event(Events.ON_CHANGE, this, null));
            });
            if ((dataField2 instanceof Textbox) && rows2 > 1) {
